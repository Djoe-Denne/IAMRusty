...
impl GitHubAuthRequest {
    ...
    pub fn standard() -> Self {
        Self {
            ...
            redirect_uri: "http://127.0.0.1:8081/iam/api/auth/github/callback".to_string(),
    ...
    pub fn linking_flow() -> Self {
        Self {
            client_id: "test_client_id".to_string(),
            redirect_uri: "http://127.0.0.1:8081/iam/api/auth/github/relink-callback".to_string(),
            scope: "user:email".to_string(),
...
impl GitHubTokenRequest {
    ...
    pub fn valid() -> Self {
        Self {
            ...
            redirect_uri: Some("http://127.0.0.1:8081/iam/api/auth/github/callback".to_string()),
        }
    }
...
impl GitHubUserRequest {
    ...
    pub fn authenticated() -> Self {
        Self {
            access_token: "gho_test_access_token_12345".to_string(),
            user_agent: "GitHub-Connect".to_string(),
