...
pub async fn create_app_routes(
    ...
    RouteBuilder::new(state.clone())
        ...
        // Project list is optional-auth and filtered in the service layer; UUID-scoped reads
        // below also flow through permission middleware for anonymous/public access checks.
