...
pub trait OrganizationRepository: Send + Sync {
    ...
    async fn find_by_user_membership(&self, user_id: &Uuid, page: u32, page_size: u32) -> Result<Vec<Organization>, DomainError>;

    /// Search organizations by name
    async fn search_by_name(&self, name_pattern: &str, page: u32, page_size: u32) -> Result<Vec<Organization>, DomainError>;
...
/// Repository port for OrganizationRole entities
#[async_trait]
...
pub trait OrganizationInvitationRepository: Send + Sync {
    ...
    /// Find pending invitations by organization and email
