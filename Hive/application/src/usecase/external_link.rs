...
use rustycog_events::MultiQueueEventPublisher;
...
impl ExternalLinkUseCase for ExternalLinkUseCaseImpl {
    async fn create_link(
        ...
        self.publish_external_link_created_event(
            organization_id,
            &external_link.organization_name,
            external_link.id,
            &external_link.provider_type,
            user_id,
        ...
        Ok(ExternalLinkResponse {
            ...
            sync_enabled: false,
            provider_name: external_link.provider_name,
            ...
            last_sync_status: external_link.last_sync_status,
