...
mod m20240101_000002_create_organization_roles_table;
...
mod m20240101_000011_drop_organization_roles_table;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20240101_000002_create_organization_roles_table::Migration),
            ...
            Box::new(m20240101_000011_drop_organization_roles_table::Migration),
