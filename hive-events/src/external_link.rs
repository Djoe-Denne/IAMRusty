...
impl ExternalLinkCreatedEvent {
    pub fn new(organization_id: Uuid, organization_name: String, external_link_id: Uuid, provider_type: String, created_by_user_id: Uuid, created_at: DateTime<Utc>) -> Self {
        Self {
