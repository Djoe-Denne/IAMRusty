//! HTTP routes for GitLab Connect: health plus HMAC-protected `/v1/*`.

use std::sync::Arc;

use axum::Router;
use gitlab_connect_configuration::ServerConfig;
