//! GitLab Connect standalone binary.

use gitlab_connect_configuration::load_config;
use gitlab_connect_setup::{app, config};
use tracing::info;

/// Start the GitLab Connect service.
///
/// # Errors
///
/// Returns an error if configuration cannot be loaded or the application fails
/// to build or run.
#[tokio::main]
