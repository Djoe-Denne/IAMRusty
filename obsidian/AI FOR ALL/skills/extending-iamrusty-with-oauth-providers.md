...
- [[concepts/oauth-provider-linking]] - Existing provider-link semantics the new provider must preserve.
- [[concepts/structured-service-configuration]] - Config model the provider must plug into.
- [[references/iamrusty-api-and-auth-flows]] - Route and handler behavior affected by provider expansion.
