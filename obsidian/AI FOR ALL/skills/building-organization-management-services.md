...
- [[concepts/organization-resource-authorization]] - Authorization model to preserve when building the API.
- [[concepts/invitation-driven-membership]] - Invitation-first onboarding pattern.
- [[concepts/external-provider-sync-jobs]] - External integration and sync-job pattern.