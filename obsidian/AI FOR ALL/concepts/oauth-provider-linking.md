...
- [[concepts/oauth-state-and-csrf-protection]] - State handling and callback validation that protect the flow.
- [[references/iamrusty-api-and-auth-flows]] - Route-level behavior for login, link, relink, and provider-token endpoints.
- [[references/iamrusty-runtime-and-security]] - Security guidance that motivates the linking constraints.
