...
- [[references/telegraph-event-processing]] - End-to-end queue consumer to processor pipeline.
- [[references/telegraph-service]] - Composition-root context for the shared command service.
