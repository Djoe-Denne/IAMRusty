...
- [[concepts/multi-channel-delivery-modes]] - Delivery-mode model that sits on top of the descriptor system.
- [[references/telegraph-event-processing]] - Where descriptors are loaded inside the event pipeline.
- [[references/telegraph-runtime-and-configuration]] - Config and path conventions around templates and descriptors.
