...
- [[concepts/descriptor-driven-communications]] - Descriptor system that feeds the active email and notification channels.
- [[references/telegraph-event-processing]] - Event pipeline that currently wires the active handlers.
- [[references/telegraph-http-and-notification-api]] - Live route surface versus broader communication DTOs.
