...
- [[references/hive-runtime-and-configuration]] - Config sections that shape outbound integrations.
- [[references/hive-http-api-and-openapi-drift]] - HTTP and contract mismatch for external-link and sync endpoints.