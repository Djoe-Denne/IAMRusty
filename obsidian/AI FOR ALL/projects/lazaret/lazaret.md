...
summary: >-
  ...
  Enrollment persisté dans Postgres Lazaret ; hole in-memory fermé.
...
- Tests T3–T10 sous `Lazaret/tests/apparatus_p3_t*.rs`. T10 persiste l’enrollment dans Postgres (`apparatus_enrollments`) et le révoque sur `component_removed`. Skill : [[projects/lazaret/skills/running-apparatus-p3-tests]].
