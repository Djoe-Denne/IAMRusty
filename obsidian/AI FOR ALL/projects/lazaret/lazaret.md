...
- Tests T3–T7 sous `Lazaret/tests/apparatus_p3_t*.rs`. Skill : [[projects/lazaret/skills/running-apparatus-p3-tests]].

`Lazaret/README.md` dit encore « Slice T2 : health / ready uniquement » — **périmé** vis-à-vis du code et de l’ADR (T1–T7 Partial). ^[ambiguous]
