...
- HTTP -> entities: [[entities/route-builder]], [[entities/resource-id]], [[entities/permissions-fetcher]] | concept: [[concepts/resource-scoped-permission-fetchers]] | skill: [[skills/using-rustycog-http]]
- Permission -> entities: [[entities/permissions-fetcher]], [[entities/resource-id]] | concept: [[concepts/resource-scoped-permission-fetchers]] | skill: [[skills/using-rustycog-permission]]
- Testing -> entities: [[entities/event-publisher]], [[entities/queue-config]], [[entities/route-builder]] | concept: [[concepts/integration-testing-with-real-infrastructure]] | skill: [[skills/using-rustycog-testing]]
