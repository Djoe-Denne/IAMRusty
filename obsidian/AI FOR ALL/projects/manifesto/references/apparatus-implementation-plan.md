...
- Consommateur Lazaret de `component_removed` (`manifesto-events`).
- `kv_purge` pour le namespace du binding disparu (Postgres et Redis, T8).
- Après remove : namespace A illisible ; voisin B intact ; replay no-op.
