...
- [[concepts/queue-driven-command-processing]] - Async command dispatch pattern behind the consumer.
- [[concepts/descriptor-driven-communications]] - Descriptor and template system used by the processors.
- [[references/telegraph-testing-and-smtp-fixtures]] - Tests that prove the main event paths.
