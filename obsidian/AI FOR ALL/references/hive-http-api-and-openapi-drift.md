...
- [[concepts/organization-resource-authorization]] - Permission model attached to the live routes.
- [[references/hive-command-execution]] - Registry breadth versus live route exposure.
- [[references/hive-testing-and-api-fixtures]] - Tests that reveal the actual HTTP contract.