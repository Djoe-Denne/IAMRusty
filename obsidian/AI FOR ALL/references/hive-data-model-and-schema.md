...
- [[concepts/organization-resource-authorization]] - Permission checks built on top of these tables.
- [[concepts/external-provider-sync-jobs]] - External-link and sync-job flows built on the schema.
- [[references/hive-http-api-and-openapi-drift]] - API surface that only partially exposes this model.