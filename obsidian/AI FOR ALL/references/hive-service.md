...
- [[references/hive-runtime-and-configuration]] - Typed config, event publisher, and environment behavior.
- [[references/hive-http-api-and-openapi-drift]] - Route-level view of the live HTTP surface.
- [[references/hive-command-execution]] - Registry and event-publishing use case coverage.