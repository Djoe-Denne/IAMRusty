...
- [[concepts/multi-channel-delivery-modes]] - Broader communication DTOs versus the live notification-only routes.
- [[references/telegraph-service]] - Service shape and `rustycog_http` routing context.
- [[references/telegraph-testing-and-smtp-fixtures]] - Integration tests that exercise the live API.
