...
- [[concepts/oauth-provider-linking]] - Link and relink semantics in the authenticated flow.
- [[concepts/oauth-state-and-csrf-protection]] - Callback validation and state handling.
- [[references/iamrusty-service]] - Route-table and runtime composition context.
