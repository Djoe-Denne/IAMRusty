...
use infra::repository::entity::refresh_tokens::{Entity as RefreshTokensEntity, Model as RefreshTokenModel, ActiveModel as RefreshTokenActiveModel};
...
impl DbFixture<RefreshTokensEntity, RefreshTokenModel, RefreshTokenActiveModel> for RefreshTokenFixtureBuilder {
    async fn commit(self, db: &DatabaseConnection) -> Result<CommittedFixture<RefreshTokenModel>, DbErr> {
