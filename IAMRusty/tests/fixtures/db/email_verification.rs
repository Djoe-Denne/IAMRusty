...
use infra::repository::entity::user_email_verification::{Entity as EmailVerificationEntity, Model as EmailVerificationModel, ActiveModel as EmailVerificationActiveModel};
...
impl EmailVerificationFixtureBuilder {
    ...
    pub async fn commit(self, db: Arc<DatabaseConnection>) -> Result<EmailVerificationFixture, DbErr> {
...
impl DbFixture<EmailVerificationEntity, EmailVerificationModel, EmailVerificationActiveModel> for EmailVerificationFixtureBuilder {
    async fn commit(self, db: &DatabaseConnection) -> Result<CommittedFixture<EmailVerificationModel>, DbErr> {
    ...
    fn model(&self) -> EmailVerificationActiveModel {
        ...
        EmailVerificationActiveModel {
            ...
            verification_token: ActiveValue::Set(self.verification_token.clone().unwrap_or_else(Self::generate_verification_token)),
